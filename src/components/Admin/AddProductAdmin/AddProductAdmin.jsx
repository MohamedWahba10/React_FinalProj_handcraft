  ...
  async function callAddProduct(values) {
    ...
    try {
      const response = await axios.post(
        `http://127.0.0.1:8000/api/panel/productadd/`,
        formData
      );
                ...
                <div className="col-md-12">
                  <div className="form-group">
                    ...
                    <select
                      className="w-100 "
                      id="prodVendor"
                      value={AddProductForm.values.prodVendor}
                      name="prodVendor"
                      onChange={AddProductForm.handleChange}
                      onBlur={AddProductForm.handleBlur}
                    >
                    ...
                    {AddProductForm.errors.prodVendor &&
                      AddProductForm.touched.prodVendor && (
                        <div className="text-danger fs-5 mt-3">
                          {AddProductForm.errors.prodVendor}
                        </div>
                      )}
